"""
Embedding stage for the unified HADES-PathRAG pipeline.
...
try:
    from src.embedding.registry import get_adapter
...
class EmbeddingStage(PipelineStage):
    ...
    def __init__(
        ...
        if EMBEDDING_AVAILABLE:
            try:
                self.embedding_adapter = get_adapter(self.adapter_name)
