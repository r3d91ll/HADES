"""
Engine interface types for HADES model engines.

This module provides centralized type definitions for the model engine interfaces
used throughout the HADES system, including both abstract base classes
...
class ModelEngine(ABC):
    """Base class for all model engines in HADES.
