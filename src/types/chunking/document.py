...
class DocumentSchema(DocumentSchemaBase):
    """Complete document schema for document processing.
    
    This is the main document schema used throughout the chunking system.
    It extends the base schema with additional fields as needed.
    """
...
DocumentSchemaType = Union[Dict[str, Any], BaseDocument, DocumentSchema]
