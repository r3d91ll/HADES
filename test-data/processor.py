    ...
    def process_document(
        ...
        **kwargs: Any
        ...
        try:
            ...
            # Extract plain text for raw_content
            raw_text = ""
            if hasattr(conversion_result.document, 'texts') and conversion_result.document.texts:
                raw_text = "\n".join([text.text for text in conversion_result.document.texts])
            ...
            return ProcessedDocument(
                ...
                raw_content=raw_text or markdown_content,  # Fallback to markdown if no raw text
